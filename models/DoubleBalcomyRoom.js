...
const doubleBalconyRoomSchema = new mongoose.Schema({
...
const DoubleBalconyRoom = new mongoose.model('DoubleBalconyRoom', doubleBalconyRoomSchema);

module.exports = DoubleBalconyRoom;