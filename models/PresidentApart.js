...
const presidentApartSchema = new mongoose.Schema({
...
const PresidentApart = new mongoose.model('PresidentApart', presidentApartSchema);

module.exports = PresidentApart;